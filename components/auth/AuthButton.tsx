"use client";
import { AuthType, SignupSuccessResponse } from "@/interfaces/auth";
  ...
  return (
    <Field>
      <Button
        ...
        className="flex items-center h-9 justify-center gap-2 bg-[#e2b714] text-[#323437] font-semibold hover:bg-[#e2b714]/90 disabled:bg-[#e2b714]/70  transition-colors"
      >
      ...
      <FieldDescription className="text-center text-[#d1d0c5]">
        {data.description}{" "}
        <Link
          href={`${data.link}`}
